...
from evaluation_object import cal_loss, normal_loss, train_op
...
class SegNet:
    def __init__(self, conf_file="config.json"):
        ...
        with self.graph.as_default():
            ...
            # ---------------------Encoder process has been Finished--------------------------------------#
            # ------------------Decoder process starts-----------------------------------------------------#
    ...
    def train(self, max_steps=19000, batch_size=3):
    ...
    def test(self):
        ...
        with self.graph.as_default():
            with self.sess as sess:
                ...
                saver.restore(self.sess, os.path.join(self.saved_dir, 'model.ckpt-19'))
